...
<?php include('chocolate-code.php'); ?>
        ...
        <div class="content">
            ...
            ?>
                <tr>
                    ...
                    <td> <a href="staffmenu-chocolate.php?edit=<?php echo $row['food_id']; ?>" class="edit_btn" style="text-decoration:none; color: white;">Edit</a> 
                     <br> <a href="chocolate-code.php?del=<?php echo $row['food_id']; ?>" class="del_btn" style="text-decoration:none; color:white;" onclick="return check()">Delete</a> </td>  
                </tr>
                <?php
                $x++;
                }
            ...
            <form method="post" action="chocolate-code.php" >

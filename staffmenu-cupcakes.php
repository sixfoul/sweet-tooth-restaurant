        ...
        <div class="content">
            ...
            ?>
                <tr>
                    ...
                    <td> <a href="staffmenu-cupcakes.php?edit=<?php echo $row['food_id']; ?>" class="edit_btn" style="text-decoration:none; color: white;">Edit</a> 
                     <br> <a href="cupcakes-code.php?del=<?php echo $row['food_id']; ?>" class="del_btn" style="text-decoration:none; color:white;" onclick="return check()">Delete</a> </td>  
                </tr>
                <?php
                $x++;
                }
            ...
            <form method="post" action="cupcakes-code.php" >
